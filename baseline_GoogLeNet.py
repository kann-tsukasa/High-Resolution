    ...
    for epoch in range(args.epochs):
        ...
        if test_acc > best_test_acc:
            ...
            if args.checkpoint_path:
                ...
                checkpoint_path = os.path.join(args.checkpoint_path, 'model_googlenet.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', default='./checkpoint/googlenet', type=str, help='checkpoint path')
    parser.add_argument('--tensorboard_path', default='./tensorboard/googlenet', type=str, help='tensorboard path')
