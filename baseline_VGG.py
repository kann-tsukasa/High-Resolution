...
def main(args):
    ...
    model = VGG(config=cfg, input_size=args.img_size, n_classes=args.num_classes)
    ...
    for epoch in range(args.epochs):
        ...
        if test_acc > best_test_acc:
            ...
            if args.checkpoint_path:
                ...
                checkpoint_path = os.path.join(args.checkpoint_path, 'model_vgg.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_path', default='./checkpoint/vgg', type=str, help='checkpoint path')
    parser.add_argument('--tensorboard_path', default='./tensorboard/vgg', type=str, help='tensorboard path')
